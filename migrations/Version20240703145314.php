 ...
 */
final class Version20240703145314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE election (id INT AUTO_INCREMENT NOT NULL, theme VARCHAR(100) NOT NULL, nombre_places_gagnants INT NOT NULL, status VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE resultat (id INT AUTO_INCREMENT NOT NULL, election_id INT NOT NULL, position INT NOT NULL, nombre_de_vote INT NOT NULL, INDEX IDX_E7DB5DE2A708DAFF (election_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE resultat ADD CONSTRAINT FK_E7DB5DE2A708DAFF FOREIGN KEY (election_id) REFERENCES election (id)');
    }
